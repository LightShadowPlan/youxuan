...
var storage = multer.diskStorage({
    ...
    destination: function (req, file, cb) {
        cb(null, PATH.resolve(__dirname, '../public/images/musicImg'))
    },
    // 文件名字
    filename: function (req, file, cb) {
        ...
        req.body.picture = '/images/musicImg/' + _filename
        cb(null, _filename)
    }
})
...
// 已经是一个中间件了
var upload = multer({ storage, fileFilter }).single('picture')  // .single处理单文件上层
