...
router.post('/selectGoodsCount', position_controller.selectGoodsCount)
router.post('/updateGoods', position_controller.updateGoods)
router.post('/removeGoods', position_controller.removeGoods)
router.post('/deleteGoods', position_controller.deleteGoods)
...
router.post('/selectTransactionsCount', position_controller.selectTransactionsCount)
